...
export default function EclProjectList() {
  ...
  const [projects, setProjects] = useState([
    { id: 1, name: 'ECL_Invest_Jan25', status: 'In Progress', progress: 0, reportingDate: '1/31/2025', type: types[0] },
    { id: 2, name: 'ECL_Invest_Dec24', status: 'Completed', progress: 0, reportingDate: '12/31/2024', type: types[0] },
  ]);
            ...
            >
              ...
              >
                <div className="d-flex justify-content-between align-items-center p-4">
                  <h2 className="m-0">Investment ECL</h2>
                  <Button

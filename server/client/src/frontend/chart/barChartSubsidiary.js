...
const ChartSubsidiary = (args) => {
    ...
    const Colors = {
        "Kas Setara Kas": "#1E2B74",       // Navy
        "Deposito": "#3554A1",            // Indigo
        "Obligasi": "#647DCE",            // Periwinkle
        "Piutang": "#9DBBFF",             // Pale blue

        "stage1": "#007B8A",              // Deep teal
        "stage2": "#8C2B74",              // Plum
        "stage3": "#D75FA0",              // Muted rose

        "Bucket1": "#007B8A",             // Matches stage1
        "Bucket2": "#8C2B74",
        "Bucket3": "#D75FA0",
        "Bucket4": "#E8BFD4",             // Light rose
    };

    const ColorsAC = {
        // Insurance
        "SafeGuard Insurance": "#1E2B74",
        "SafeGuard Insurance Putera": "#3554A1",
        "National Reinsurance": "#647DCE",
        "Insurance Subsidiary": "#9DBBFF",

        // Syariah
        "SCOV Syariah": "#007B8A",
        "TRUST Syariah": "#8C2B74",
        "SureGuarantee Syariah": "#D75FA0",

        // Investment
        "Investment Subsidiary": "#E5B94F",   // muted gold
        "Alpha Asset Management": "#2C764F",  // dark green
        "Beta Securities": "#8A8A8A",

        // Others
        "Holding Company": "#B22222",
        "ECL": "#8B0000",
        "Outstanding": "#C49A00",
    };
    ...
    const total_ECL_instrument_on_selected_month = (month) => {
        ...
        const labels = ["Kas Setara Kas", "Deposito", "Obligasi", "Piutang"]
        const instrumentECL = [0, 0, 0, 0]
        ...
        Object.entries(monthDataPiutang[1]).forEach((monthDataKeyData) => {
            ...
            if (selectedAc != 'Bahana Artha Ventura') {
                ...
                if (["bucket1", "bucket2", "bucket3", "bucket4"].includes(monthDataKeyData[0])) {
                    instrumentECL[3] += monthDataKeyData[1][1]
                }
            } else {
                if (["stage1", "stage2", "stage3"].includes(monthDataKeyData[0])) {
                    instrumentECL[3] += monthDataKeyData[1][1]
        ...
        <div className="row">
            <div className="col-md-12">
                    ...
                    <div className="col-md-6">
                        <Plot
                            ...
                            layout={{
                                ...
                                // xaxis: { title: {text:`Instruments`} },
                                yaxis: {
                                    // title: {text:`Total ECL for Giro`},
                    ...
                    <div className="col-md-6">
                        <Plot
                            ...
                            layout={{
                                ...
                                // xaxis: { title: {text:`Instruments`} },
                                yaxis: {
                                    // title: {text:`Total ECL for Deposito`},
                                    // range: [0, 130000000], // Set y-axis max value to be a fixed range
                                },
                            }}
                            useResizeHandler={true} // Enables responsive resizing
                    ...
                    <div className="col-md-6">
                        <Plot
                            ...
                            layout={{
                                ...
                                // xaxis: { title: {text:`Instruments`} },
                                yaxis: {
                                    // title: {text:`Total ECL for Obligasi`},
                                    // range: [0, 130000000], // Set y-axis max value to be a fixed range
                                },
                            }}
                            useResizeHandler={true} // Enables responsive resizing
                    ...
                    <div className="col-md-6">
                        <Plot
                            data={[{
                                ...
                                type: "bar",
                                marker: {
                                    color: ChartColorsPiutang, // Apply different colors for each category
                                },
                            }]}
                            layout={{
                                autosize: true, // Enables responsive behavior
                                ...
                                // xaxis: { title: {text:`Instruments`} },
                                yaxis: {
                                    // title: {text:`Total ECL for Piutang`},
                                    // range: [0, 130000000], // Set y-axis max value to be a fixed range
                                },
                            }}
                            useResizeHandler={true} // Enables responsive resizing
                ...
                <div className="row mt-4">
                    <h5 style={{ fontWeight: 'bold', textAlign: 'center' }}>Trend Outstanding Amount & ECL</h5>
                </div>
                ...
                <div className="row">
                    ...
                    <div className="col-md-2">
                        <select className="form-select" value={selectedInstrumentMove} onChange={handleInstrumentMoveChange}>
                            <option key="Total" value="Total">Total</option>
                            <option key="Kas dan setara Kas" value="Kas dan setara Kas">Kas dan setara Kas</option>
                            <option key="Deposito" value="Deposito">Deposito</option>
                            <option key="Obligasi" value="Obligasi">Obligasi</option>
                        </select>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-md-12">
                        <Plot
                            ...
                            layout={{
                                autosize: true,
                                // title: {text:`<b>Trend Outstanding & ECL</b>`},
                                xaxis: { title: { text: `Date` } },
                                yaxis: {
                                    title: { text: `Amount OS` },
                                    // range: [0, 130000000], // Set y-axis max value to be a fixed range
                                },
                                yaxis2: {
                                    title: { text: `Amount ECL` },
                                    overlaying: 'y',
                                    side: 'right'
                                    // range: [0, 130000000], // Set y-axis max value to be a fixed range
                                },
                ...
                <hr className="mt-4 mb-4" />
                {/* <div className="row mt-4">
                    <h5 style={{ fontWeight: 'bold', textAlign: 'center' }}>Trend Outstanding & ECL</h5>
                </div> */}
                ...
                <div className="row">
                    <div className="col-md-4">
                        <Plot
                            ...
                            layout={{
                                autosize: true,
                                title: { text: `Outstanding Amount & ECL Comparison` },
                                barmode: 'group',
                                legend: {

...
const ChartSubsidiaryNonInvest = (args) => {
    // Data for each month
    ...
    const ColorsAC = {
        ...
        "Alpha Asset Management": "#269IFG Holding",
    ...
    const total_ECL_instrument_on_selected_month = (month) => {
        ...
        const labels = ["Piutang"]
        const instrumentECL = [0]
        ...
        Object.entries(monthDataPiutang[1]).forEach((monthDataKeyData) => {
            ...
            if (selectedAc != 'Bahana Artha Ventura') {
                ...
                if (["bucket1", "bucket2", "bucket3", "bucket4"].includes(monthDataKeyData[0])) {
                    instrumentECL[0] += monthDataKeyData[1][1]
                }
            } else {
    ...
    const interco_OS_ECL_detail_month = (month) => {
        ...
        const ECLdata = {
            ...
            y: [
                ...
                , allAc[selectedAc][month]["interco Central Holdings Life"] ? allAc[selectedAc][month]["interco Central Holdings Life"][1] : 0
                ...
                , allAc[selectedAc][month]["interco Bahana TCW Investment Managemen"] ? allAc[selectedAc][month]["inIFG HoldingW Investment Managemen"][1] : 0
        ...
        const OSdata = {
            ...
            y: [
                ...
                , allAc[selectedAc][month]["interco Central Holdings Life"] ? allAc[selectedAc][month]["interco Central Holdings Life"][0] : 0
                ...
                , allAc[selectedAc][month]["interco Bahana TCIFG Holdingnagemen"] ? allAc[selectedAc][month]["interco Bahana TCW InIFG Holdingmen"][0] : 0
        ...
        <div className="row">
            <div className="col-md-12">
                ...
                <div className="row mb-1 m-0 p-0" style={{ minHeight: '50vh' }}>
                    ...
                    <div className="col-md-3 p-0" style={{ alignContent: 'center' }}>
                ...
                <div className="row mt-5">
                    <h5 style={{ fontWeight: 'bold', textAlign: 'center' }}>Total ECL per Bucket</h5>
                </div>
...
export default ChartSubsidiaryNonInvest;

...
export default function ModelListLRSekuritasHolding() {
  const types = [
...
const companyOptions = [
  ...
  const [projects, setProjects] = useState([
    { id: 1, projectName: "Securities 1", name: 'GRAHANIAGA TATAUTAMA', status: 'In Progress', progress: 0, reportingDate: new Date(), type: types[0] },
    { id: 2, projectName: "Securities 2", name: 'BAHANA – Sekuritas', status: 'Completed', progress: 0, reportingDate: new Date(), type: types[0] },
    // { id: 3, projectName: "Securities 3", name: 'JASA RAHARJA', status: 'Completed', progress: 0, reportingDate: new Date(), type: types[0] },
  ]);
  ...
  const columns = [
    {
      ...
      selector: (project) => (
        project.status === 'Completed' ?
          ...
          <Link
            to={{
              pathname: "/modeling-loss-rate-sekuritas", // Conditional path
            ...
            >
              ...
              >
                <div className="d-flex justify-content-between align-items-center p-4">
                  <h2 className="m-0">List of Project for Modelling Securities</h2>
                  <Button

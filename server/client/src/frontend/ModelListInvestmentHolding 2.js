...
export default function ModelListInvestmentHolding() {
  ...
  const [projects, setProjects] = useState([
    { id: 1, projectName: "Invest 1", name: 'Investment Subsidiary', status: 'In Progress', progress: 0, reportingDate: new Date(), type: types[0] },
    { id: 2, projectName: "Invest 2", name: 'Beta Securities', status: 'Completed', progress: 0, reportingDate: new Date(), type: types[0] },
  ...
  const columns = [
    {
      ...
      selector: (project) => (
        project.status === 'Completed' ?
          ...
          <Link
            to={{
              pathname: "/modeling-investment", // Conditional path
            ...
            >
              ...
              >
                <div className="d-flex justify-content-between align-items-center p-4">
                  <h2 className="m-0">List of Project for Investment Tariff</h2>
                  <Button

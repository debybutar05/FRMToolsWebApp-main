...
export default function ModelListInvestmentHolding() {
  ...
  const [projects, setProjects] = useState([
    { id: 0, projectName: "Regress_Jan2025", combination: "2", status: "In Progress", progress: 0, reportingDate: new Date(2025, 0, 31) },
            ...
            >
              ...
              >
                <div className="d-flex justify-content-between align-items-center p-4">
                  <h2 className="m-0">Tariff for Investment Portfolio</h2>
                  <Button

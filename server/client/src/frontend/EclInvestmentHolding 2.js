...
export default function EclInvestmentHolding() {
  ...
  const [projects2, setProjects2] = useState([
    { id: 1, name: 'Project 1', status: 'In Progress', progress: 0, reportingDate: '1/31/2025', type: types2[0] },
    { id: 2, name: 'Project 2', status: 'Completed', progress: 0, reportingDate: '12/31/2024', type: types2[0] },
  ]);
  ...
  const filesList = [
    'vasicek_final_ecl_changed.csv',
    'vasicek_final_ecl.csv',
  ];

  const [projects, setProjects] = useState([
    { id: 0, projectName: 'Project 001', name: 'TRUST', status: 'In Progress', progress: 0, reportingDate: "1/31/2025", type: types[0] },
    { id: 1, projectName: 'Project 002', name: 'Investment Subsidiary', status: 'Completed', progress: 0, reportingDate: "12/31/2024", type: types[0] },
  ...
  const columns = [
    {
      ...
      selector: (project) => (<Link
        to={{
          pathname: project.status === 'Completed' ? "/Report" : "/ecl-calculation-loss-rate-vintage", // Conditional path
          ...
          if (filesProcessed === filesList.length) {
            zip.generateAsync({ type: 'blob' })
              .then((content) => {
                ...
                link.download = 'EClVasicekInvestment.zip';
                link.click();
              })
              .catch(err => {
            ...
            >
              ...
              >
                ...
                <div className="d-flex justify-content-between align-items-center p-4">
                  <h2 className="m-0">Holding Company ECL Investment Calculation</h2>
                  <Button
                ...
                <div className="d-flex justify-content-between align-items-center p-4">
                  <h2 className="m-0">Affiliated Company ECL Investment Calculation</h2>
                </div>

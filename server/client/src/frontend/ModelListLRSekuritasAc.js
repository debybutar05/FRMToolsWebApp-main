...
export default function ModelListLRSekuritasAc() {
  const types = [
...
const companyOptions = [
  ...
  const [projects, setProjects] = useState([
    ...
    { id: 2, name: 'GRAHANIAGA TATAUTAMA', status: 'Completed', progress: 0, reportingDate: "9/30/2023", type: types[0] },
    { id: 3, name: 'GRAHANIAGA TATAUTAMA', status: 'Completed', progress: 0, reportingDate: "10/31/2022", type: types[0] },
  ]);
            ...
            >
              ...
              >
                <div className="d-flex justify-content-between align-items-center p-4">
                  <h2 className="m-0">List of Projects for List Securities</h2>
                  {/* <Button

...
export default function ModelListLRVintageHolding() {
  ...
  const [projects, setProjects] = useState([
    { id: 1, projectName: "Non-Investment 1", name: 'Beta Securities', status: 'In Progress', progress: 0, reportingDate: new Date(), type: types[0] },
    { id: 2, projectName: "Non-Investment 2", name: 'Investment Subsidiary', status: 'In Progress', progress: 0, reportingDate: new Date(), type: types[1] },
    { id: 3, projectName: "Non-Investment 3", name: 'SafeGuard Insurance', status: 'Completed', progress: 0, reportingDate: new Date(), type: types[1] },
  ]);
            ...
            >
              ...
              >
                <div className="d-flex justify-content-between align-items-center p-4">
                  <h2 className="m-0">List of Project for Non-Investment Tariff</h2>
                  <Button

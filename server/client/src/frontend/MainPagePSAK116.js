...
import MonitoringProgress116 from './chart/MonitoringProgress116';
import ChartWithDropdownP116 from './chart/chart116';
import ChartWithDropdownP116Holding from './chart/chart116Holding';
// import ChartWithDropdownHolding2 from './chart/barChartHolding2';

export default function MainPagePSAK116() {
            ...
            <div className="card flex" style={{ width: "100%", minHeight: "90%", alignSelf: "start", alignItems: "center", zIndex: "999" }}>
              <div className="card-body col-12 p-4" style={{ justifyContent: "flex-start", alignItems: "start", height: 'auto' }}>
                ...
                <Tabs
                  ...
                  activeKey={key}
                  onSelect={(k) => setKey(k || 'chart1')}
                  className="mb-3"
                  >
                  <Tab eventKey="chart1" title="Total PSAK116">
                    {key === "chart1" &&
                      <div>
                        <ChartWithDropdownP116Holding />
                        {/* <ChartWithDropdownHolding2 /> */}
                      </div>
                    }
                  </Tab>
                  <Tab eventKey="chart2" title="Stand Alone PSAK116 Calculation">
                    {key === "chart2" &&
                      <div>
                        <ChartWithDropdownP116 acName='All' />
                        {/* <ChartWithDropdownHolding2 /> */}
                      </div>
                    }
                  </Tab>
                ...
                >
                  ...
                  <Tab eventKey="chart2" title="Individual ECL">
                    {key === "chart2" &&
                      <ChartSubsidiary acName='All' />
                    }
                  </Tab>

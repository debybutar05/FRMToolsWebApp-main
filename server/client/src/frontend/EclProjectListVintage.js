...
export default function EclProjectListVintage() {
  const types = [
  ...
  const [projects, setProjects] = useState([
    { id: 0, name: 'ECL_NonInvest_Feb25', status: 'In Progress', progress: 0, reportingDate: '2/28/2025', type: types[0] },
    { id: 1, name: 'ECL_NonInvest_Jan25', status: 'In Progress', progress: 0, reportingDate: '1/31/2025', type: types[1] },
    { id: 2, name: 'ECL_NonInvest_Dec24', status: 'Completed', progress: 0, reportingDate: '12/31/2024', type: types[1] },
  ]);
  ...
  const columns = [
    {
      ...
      selector: (project) => (
        project.status === 'Completed' ?
          ...
          :
          <Link
            // to={'/ecl-calculation-loss-rate-vintage'}
            to={{
              pathname: project.type === types[0]
                ? '/ecl-calculation-loss-rate-vintage'
                : project.type === types[1]
                  ? '/ecl-calculation-loss-rate-sekuritas'
                  : '/ecl-calculation-loss-rate-vintage',

...
export default function ModelListLRVintageHolding() {
  ...
  const [projects, setProjects] = useState([
    { id: 1, projectName: "Tariff01_Feb2025", status: 'In Progress', progress: 0, reportingDate: new Date(), type: types[0] },
    { id: 2, projectName: "Tariff02_Feb2025", status: 'Completed', progress: 0, reportingDate: new Date(), type: types[0] },
  ]);
